...
`,topics:["Sorting Algorithms","Insertion Sort","Algorithm Analysis","Adaptive Algorithms","Stable Sorting"],example_videos:["https://youtu.be/0MCzyKK08Jc"]}},"content/chapter-01/questions/linear-search-complexity.yml":{type:"yaml",module:{id:"ch1-linear-search-complexity",type:"short-answer",chapter:1,question:`**Write an algorithm that searches for a target value in an unsorted array.**
...
`,topics:["Binary Search Trees","AVL Trees","Balanced Trees","Tree Rotations","Performance Trade-offs"],example_videos:["https://youtu.be/_Evb3EM8AH0"]}},"content/chapter-02/questions/btree-analysis.yml":{type:"yaml",module:{id:"ch2-btree-analysis",type:"short-answer",chapter:2,question:`**Implement and explain B-Trees.**
...
`,topics:["Dijkstra's Algorithm","Shortest Paths","Priority Queue","Algorithm Limitations","Negative Edges","Path Reconstruction","Predecessor Array"],example_videos:["https://youtu.be/D7aaPG62poU"]}},"content/chapter-02/questions/fibonacci-call-tree-optimizations-and-analysis.yml":{type:"yaml",module:{id:"ch2-fibonacci-call-tree-optimizations-and-analysis",type:"short-answer",chapter:2,question:`**Write three implementations of the Fibonacci function: (1) naive recursive, (2) memoized recursive, and (3) iterative bottom-up.**
...
`,topics:["Recursion","Dynamic Programming","Memoization","Call Trees","Recurrence Relations","Algorithm Optimization"],example_videos:["https://youtu.be/Hfwcsbtg_7U"]}},"content/chapter-02/questions/graph-representation.yml":{type:"yaml",module:{id:"ch2-graph-representation",type:"short-answer",chapter:2,question:`**Compare data structures for storing graphs.**
...
`,topics:["Algorithm Analysis","Recursion","Iteration","Space Complexity","Call Stack"],example_videos:["https://youtu.be/Q7tPerOKRPY"]}},"content/chapter-02/questions/minimum-spanning-trees.yml":{type:"yaml",module:{id:"ch2-minimum-spanning-trees",type:"short-answer",chapter:2,question:`**Implement minimum spanning tree algorithms (Prim's and Kruskal's).**
