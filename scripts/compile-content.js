...
const typesContent = `// Auto-generated TypeScript definitions
...
export const compiledFiles: Record<string, CompiledFile>;
...
console.log('📊 Total files compiled:', yamlCount + markdownCount);
console.log('   📄 YAML:', yamlCount);
console.log('   📝 Markdown:', markdownCount);
